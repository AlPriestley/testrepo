...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        R_chart1 = dcc.Graph(figure=px.line(recession_data, x='Year', y='Automobile Sales', title="Average Automobile Sales fluctuation over Recession Period"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby('Vehicle_Yype', 'Automobile_Sales')['unemployment_rate'].mean().reset_index()
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph( figure=avr_vdata,title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year))
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(exp_data, values='Advertising_Expenditure', names='Vehicle_Type', title="Total Average Expenditure for Each Vehicle")
