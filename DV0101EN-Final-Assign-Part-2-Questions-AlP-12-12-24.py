...
# Set the title of the dashboard app.title = "Automobile Statistics Dashboard"
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart1 = dcc.Graph(figure=px.line(yearly_rec,x='Year', y='Automobile Sales', title="Average Automobile Sales fluctuation over Recession Period") )
			
	    #Plot 2 Calculate the average number of vehicles sold by vehicle type
        average_sales = recession_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()
        R_chart2 = dcc.Graph(figure=px.bar(average_sales, x='Vehicle Type', y='Automobile Sales', title= "Average Vehicle Sales for Each Vehicle Category"))
        ...
        unemp_data= recession_data.groupby(['unemployment_rate', 'Vehicle_Type'])['Automobile_Sales'].mean().sum_index()
        R_chart4 = dcc.Graph(figure=px.bar(unemp_data, x='Vehicle_Type', y='unemployment_rate', color='#503D36',
                         ...
                         children=[html.Div(children=R_chart1),
                                   ...
                                   html.Div(className='chart-item', 
                                            children=[html.Div(children=R_chart3),
                                                      ...
                                                      style={'display': 'flex'})]
    elif ((input_year and selected_statistics=='Yearly Statistics') : yearly_data = data[data['Year'] == input_year])
        ...
        print (mas)
        Y_chart2 = dcc.Graph(figure=px.line(mas, x='Month', y='Automobile_Sales', title="Monthly Automobile Sales for the year {}".format(input_year)))
        ...
        print (exp_data)
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Advertising Expenditure', names='Vehicle_Type', title='Total Advertising Expenditure for Vehicle Type in the year {}'.format(input_year)))
